...
export function ChatWindow(props: {
  ...
  const choosePDFComponent = (
    <>
      <div className="p-4 md:p-8 rounded bg-[#25252d] w-full max-h-[85%] overflow-hidden flex flex-col">
        ...
        <span className="ml-2 w-half items-center justify-center flex">
              Upload a pdf and chat with it. Fully Locally
            </span>
      </div>

      <form onSubmit={embedPDF} className="mt-8 flex justify-center items-center w-1/1   h-1/3">
  ...
  const chatInterfaceComponent = (
    <>
      ...
      <form onSubmit={sendMessage} className="flex w-full flex-col">
        <div className="flex w-half mt-4">
          <input
  ...
  return (
    <div className={`flex flex-col items-center p-4 md:p-8 w-half rounded grow overflow-hidden ${(readyToChat ? "border" : "")}`}>
