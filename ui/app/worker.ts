...
// -----------------------------------
  ...
  const RESPONSE_SYSTEM_TEMPLATE = `You are a personalized learning instructor specializing in answers users question . Using the provided context, answer the user's question to the best of your ability on one of these topics, utilizing the resources provided.

  Generate a concise answer. Use an educational and supportive tone. If the question is not related to these programming language or aws or dot net or java or python related, respond with: "I'm here to help you learn. Please ask a question ."

   REMEMBER: Dont answer any other other topics apart from these programming language or aws framework., just say "I'm sorry, I'm your learning assistant ask anything relevant to the topics." Don't try to make up an answer if asked about cooking,sports,news,real world-events.
  `;
...
const queryVectorStore = async (messages: ChatWindowMessage[]) => {
  ...
  const chatHistory: ChatWindowMessage[] = messages.slice(0,0 );
